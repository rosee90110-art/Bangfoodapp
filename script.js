...
// ฟังก์ชันเพิ่มสินค้าที่ปรับแต่งแล้วเข้าตะกร้า (จาก Modal)
...
// ฟังก์ชันคำนวณราคาสุทธิ (ต้องใช้ currentItem.basePrice ที่ถูกต้อง)
...
if (addToCartConfirmBtn) {
    addToCartConfirmBtn.addEventListener('click', () => {
        ...
        // เพิ่มสินค้าลงตะกร้าและเด้งไปหน้า cart.html
...
function renderCartItems() {
    ...
    // 1. แสดงหมายเลขโต๊ะ
    if (tableInfoEl) {
         tableInfoEl.textContent = cart.table ? `คำสั่งซื้อสำหรับ ${cart.table}` : 'ไม่มีรายการในตะกร้า';
    }
